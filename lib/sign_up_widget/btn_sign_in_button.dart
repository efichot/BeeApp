...
class btnSignInButton extends StatelessWidget {
  btnSignInButton({Key key, this.onBtnGetStartedTwoPressed, AnimationController btnSignInButtonAnimationController}) :
    translateY = Interpolation<double>(keyframes: [
      Keyframe<double>(fraction: 0, value: 0),
      Keyframe<double>(fraction: 0.001, value: 200),
      Keyframe<double>(fraction: 1, value: 0),
    ]).animate(CurvedAnimation(
      parent: btnSignInButtonAnimationController,
    ...
    return FadeTransition(
      ...
      child: TranslationTransition(
        ...
        child: FlatButton(
          ...
          color: Color.fromARGB(255, 153, 162, 169),
